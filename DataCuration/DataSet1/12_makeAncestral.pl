...
use strict;
use warnings;
open(MAP,"Outputs/SouthAmerica_dataset_QCed.KinshipFilter.AdmFilter.CPFS.bim") || die();
my $chr=0;
...
#}
#die();
open(OUT,">Outputs/SouthAmerica_dataset_QCed.KinshipFilter.AdmFilter.CPFS.ancestral")||die("write\n"); 
open(WARN,">Outputs/SouthAmerica_dataset_QCed.KinshipFilter.AdmFilter.CPFS.ancestral.WARN")||die("write\n"); 
