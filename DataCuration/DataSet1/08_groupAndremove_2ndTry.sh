...
grep -v Yanesha Outputs/SouthAmerica_dataset_QCed.KinshipFilter.AdmFilter.fam | grep -v Titicaca | grep -v Bolivia | grep -v Wichi >> Outputs/SouthAmerica_dataset_QCed.KinshipFilter.AdmFilter.CPFS.Remove
...
grep Titicaca Outputs/SouthAmerica_dataset_QCed.KinshipFilter.AdmFilter.CPFS.fam | cut -f1,2 | awk '{print $2,$1,"Andean"}' >> Outputs/SouthAmerica_dataset_QCed.KinshipFilter.AdmFilter.CPFS.NEWLABELS
grep Bolivia  Outputs/SouthAmerica_dataset_QCed.KinshipFilter.AdmFilter.CPFS.fam | cut -f1,2 | awk '{print $2,$1,"Andean"}' >> Outputs/SouthAmerica_dataset_QCed.KinshipFilter.AdmFilter.CPFS.NEWLABELS
