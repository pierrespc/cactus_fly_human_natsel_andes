...
setwd("~/Documents/PostDoc/DetoxFly/Gnecchio/Reformate/Outputs/fineStructureOnlyNat/FSTpost/")



ColorManifest<-read.table("~/Documents/PostDoc/DetoxFly/Gnecchio/Reformate/ColorManifest.tsv",stringsAsFactors = F,header=T,
                          sep="\t",comment.char = "@")
