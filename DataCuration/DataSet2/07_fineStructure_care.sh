...
mkdir /Users/pierrespc/Documents/PostDoc/DetoxFly/LAST/MaoMoreno/Reformate/Outputs/fineStructureOnlyNat/fineStructure
cd /Users/pierrespc/Documents/PostDoc/DetoxFly/LAST/MaoMoreno/Reformate/Outputs/fineStructureOnlyNat/fineStructure
...
nR=$(cat Inputs/6pops.KinshipFilter.AdmFilter.MAF0.0000001.GENO0.02.MIND0.05.ids | wc -l)
...
then
	...
	do
		...
		then
			echo $(pwd)
			fs cp \
				-g ../Inputs/6pops.KinshipFilter.AdmFilter.MAF0.0000001.GENO0.02.MIND0.05.chr$i"_alignedRef_phased.phase" \
				-r ../Inputs/chr$i.recomb \
				-t ../Inputs/6pops.KinshipFilter.AdmFilter.MAF0.0000001.GENO0.02.MIND0.05.ids \
				-i $emStage1 \
				-a 0 0 \
				-im \
				-in \
	...
	Rscript  /Users/pierrespc/Documents/PostDoc/DetoxFly/LAST/MaoMoreno/Reformate/7a_CombineSTEP1.R  {22,15,10,4}
else
...
perl  /Users/pierrespc/Documents/PostDoc/DetoxFly/LAST/MaoMoreno/Reformate/7c_ParseTree.pl stage3.tree.Other.xml /Users/pierrespc/Documents/PostDoc/DetoxFly/LAST/MaoMoreno/Reformate/Outputs/6pops.KinshipFilter.AdmFilter.MAF0.0001.GENO0.02.MIND0.05.fam 
