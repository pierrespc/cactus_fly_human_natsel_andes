...
setwd("~/Documents/PostDoc/DetoxFly/LAST/MaoMoreno/Reformate/Outputs/fineStructureOnlyNat/FSTpost/")



ColorManifest<-read.table("~/Documents/PostDoc/DetoxFly/LAST/MaoMoreno/Reformate/ColorManifest.tsv",stringsAsFactors = F,header=T,
                          sep="\t",comment.char = "@")
